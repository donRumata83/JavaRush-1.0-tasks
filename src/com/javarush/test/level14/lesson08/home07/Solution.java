...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
      ...
      {
          tmp = apartaments.get(i).getClass().getSimpleName();
          Apartament apartament = apartaments.get(i);
          switch (tmp)
          {
              case "Apt1Room" : ((Apt1Room)apartament).clean1Room();
                  break;
              case "Apt2Room": ((Apt2Room)apartament).clean2Rooms();
                  break;
              case "Apt3Room": ((Apt3Room)apartament).clean3Rooms();
                  break;
          }
      }
    }
